...
const PassengerMainHome = () => {
  ...
  // const process.env.GOOGLE_PLACES_API_KEY = 'AIzaSyD6Z0WUBBY6y5VmdfTGXjVE2qqTQjCxxu4'; // Replace with your API key
  const vehicles = [
    {
      id: "1",
      type: "Bike",
      rate: rideDetails ? `$${rideDetails.fares.bike}` : "$10",
      icon: "🚲",
      nearby: "7 nearbies",
    },
    {
      id: "2",
      type: "Economy",
      rate: rideDetails ? `$${rideDetails.fares.economy}` : "$10",
      icon: "🚗",
      nearby: "9 nearbies",
    },
    {
      id: "3",
      type: "Comfort",
      rate: rideDetails ? `$${rideDetails.fares.comfort}` : "$10",
      icon: "🚐",
      nearby: "4 nearbies",
    },
  ];
  ...
  const calculateFare = async () => {
    try {
      ...
      const response = await fetch(
        "http://192.168.100.7:3000/api/calculateFares",
        {
          method: "POST",
          headers: {
          ...
          >
            ...
            <View style={styles.inputRow}>
              <View style={styles.iconContainer}>
                <Text style={[styles.inputIcon, { color: theme.colors.text }]}>
                  📍
                </Text>
              </View>
            ...
            >
              <Text
                style={[styles.proceedButtonText, { color: theme.colors.card }]}
              >
          ...
          >
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  <Text
                    style={[styles.vehicleRate, { color: theme.colors.text }]}
                  >
                    {item.rate}
                  </Text>
                </TouchableOpacity>
            ...
            <TouchableOpacity
              style={[
                ...
                { backgroundColor: isClicked ? "#007BFF" : "#FFD700" },
              ]} // Toggle button color
              onPress={handleRideSharing} // Handle button press
            >
              <Text style={styles.confirmButtonText}>
                {isClicked ? "Disable Ride Sharing" : "Enable Ride sharing"}{" "}
              </Text>
            </TouchableOpacity>
            ...
            >
              <Text
                style={[styles.confirmButtonText, { color: theme.colors.card }]}
              >
                Confirm Vehicle
              </Text>
            </TouchableOpacity>
